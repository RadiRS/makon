   ...
   <div class="col-md-12 padding-0">
       <div class="panel box-v3">
          <div class="panel-heading bg-white border-none">
              <h4>Data baru</h4>
              <form method="POST" action="<?php echo base_url();?>data_user/update_action/<? foreach ($list as $data_user) {echo "$data_user->ID_USER";} ?>">
              <div class="col-md-12">
                            <div class="form-group"><label class="col-sm-2 control-label text-right">Nama</label>
                            <p>
                              <div class="col-sm-10"><input type="text" name="nama" class="form-control" value="<?php foreach ($list as $data_user) {echo "$data_user->NAMA_LENGKAP_USER";} ?>"></div></p>
                            </div>
                            <div class="form-group"><label class="col-sm-2 control-label text-right">Email</label>
                              <div class="col-sm-10"><input type="text" name="email" class="form-control" value="<?php foreach ($list as $data_user) {echo "$data_user->EMAIL_USER";} ?>" ></div>
                            </div>
                            <div class="form-group"><label class="col-sm-2 control-label text-right">Username</label>
                              <div class="col-sm-10"><input type="text" name="username" class="form-control" value="<?php foreach ($list as $data_user) {echo "$data_user->USERNAME";} ?>" ></div>
                            </div> 
...
<!-- start: Javascript -->
    ...
    <!-- plugins -->
    <script src="asse<? echo base_url(); ?>t/js/plugins/moment.min.js"></script>
